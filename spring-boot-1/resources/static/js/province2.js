 //定义数组，存储省份信息    
       ...
       var xianggang = ["中西区", "湾仔区", "东区", "南区", "九龙城区", "油尖旺区", "观塘区", "黄大仙区", "深水埗区", "北区", "大埔区", "沙田区", "西贡区", "元朗区", "屯门区", "荃湾区", "葵青区", "离岛区"];    
        ...
        //设置省份数据    
        function setProvince1() {    
            //给省份下拉列表赋值    
            var option, modelVal;    
            var $sel = $("#selProvince1");    
        ...
        function setCity1(provinec) {    
            ...
            //先清空之前绑定的值    
            $city.empty();    
            var str="<option value='0' id='selectFlag'>请先选择省份</option>";
        	$city.append(str);
            //设置对应省份的城市    
        ...
        //省份选中事件    
        function provinceChange1() {    
            var $pro = $("#selProvince1");    
            setCity1($pro.val());    
        }    
