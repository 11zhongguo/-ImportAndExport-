...
public class ExcelUtils {
     ...
     * @throws Exception
     */
    public static void exportExcel(HttpServletResponse response, String fileName, ExcelDate data) throws Exception {
        // 告诉浏览器用什么软件可以打开此文件
    ...
    public static int generateExcel(ExcelDate excelData, String path) throws Exception {
        File f = new File(path);
        FileOutputStream out = new FileOutputStream(f);
        return exportExcel(excelData, out);
    }
 
    private static int exportExcel(ExcelDate data, OutputStream out) throws Exception {
...
//    }
     ...
     * @return
     */
    private static int writeExcel(XSSFWorkbook wb, Sheet sheet, ExcelDate data) {
        int rowIndex = 0;
